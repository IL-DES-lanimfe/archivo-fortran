...
C auxiliares
       CHARACTER*2 DEC
       DIMENSION Sdek(NK,2),Gder(NK,2),GG0(NK)
       OPEN (13,FILE='Sdkyukz20fv3K12.dat')
       OPEN (25,FILE='fktmaxyukz20fv3K12.dat')
       OPEN (29,FILE='fktminyukz20fv3K12.dat')
       OPEN (26,FILE='deltazyukz20fv3K12.dat')
       OPEN (27,FILE='fktyukz20fv3K12.dat')
       OPEN (28,FILE='sueltosyukz20fv3K12.dat')
       OPEN (30,FILE='fsktyukz20fv3K12.dat')
CC Mensaje inicial
       write(*,*)' '
...
C     DATOS DE ENTRADA:
       ...
       READ(*,*)LAMBEL
       WRITE(*,*)'TIENES LOS MOMENTOS?(s o n)'
       READ(*,*)DEC
       WRITE(*,*)'QUE VINEYARD QUIERES?(1:ADITIVA,2:MULTIPLICATIVA)'
       WRITE(*,*)' '
	 WRITE(*,*)'RECUERDA QUE LA MULTIPLICATIVA NECESITA LOS MOMENTOS'
       WRITE(*,*)'A HUEVO, ASI QUE SI NO LOS TIENES NI LO INTENTES,JEJE'
       READ(*,*)LVINE
...
CC
       ...
       IF (DEC.EQ.'s')THEN
	  OPEN (14,FILE='selfLJMVWfv5146nu18.dat')
	  OPEN (15,FILE='colLJMVWfv5146nu18.dat')
        DO IK=1,NK
...
CC
	  ...
	  Y(IK)=Sdek(IK,1)
        S(IK)=Sdek(IK,2)
	!write(60,*)AS(IK),BS(IK),AT(IK),BT(IK)
CC
...
CC
	 WRITE(25,*)0.D0,0.D0,1.D0
	 WRITE(29,*)0.D0,0.D0,1.D0
