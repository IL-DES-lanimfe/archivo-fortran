...
C Enero 2007								C
C 									C
C Adapatado a Gaussian Core Model (GC) 					C
C									C
C Agosto 2008								C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
CC
	Double precision eps,Gder(Nk,2)
CC
...
CC
	...
	write(*,*)'parametro 1:T(temperatura)'
	write(*,*)'parametro 2:Densidad reducida'
...
CC
	...
	write(*,*)' '
	open(8,file='vidrioGC.dat') 
	open(9,file='facnoergoGC.dat')
	open(10,file='SkmaxGC.dat')
CC
...
CC
	 !z=10.D0
	dpar2=0.02D0 !(par2max-par2min)/dble(Npar2)
...
CC
	 eps=1.D0/par1ant
c... Reads inpud data
	 call input(parametro2,eps,1.D0)
...
CCC Termina la evaluacion de la  integral para valor de parametro 1 mas
C pequeño 
CC
