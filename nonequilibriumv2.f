...
CC
	if (dec.eq.1) open(20,file='relaxk10taus4.dat')
	if (dec.eq.2) open(20,file='relaxCk10taus4.dat')
...
CC
	if(dec.eq.1)then
	 Tp=Ti+delT
	 open(30,file='relax200pasosk10taus4.dat')
	endif
	if(dec.eq.2)then
	 fvp=fvi+delT
	 open(30,file='relaxC200pasosk10taus4.dat')
	endif 
CC
