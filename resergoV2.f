...
CC
	Integer iint
	Double precision y,dy,S,g,l,dez0,num,den,integral
	Double precision T(Nk)
CC
C variables axiliares
CC
	Integer i
	Double precision pi,a,dez0m
...
CC
	...
	write(*,*)'Estamos en el caso de yukawas repulsivas'
	write(*,*)'parametro 1:gamma*,parametro 2:kappa*'
...
CC
	if (dabs(solant).lt.1.D-4)then
         write(8,*)par1ant,integralant,dez0m
         write(*,*)'se encontro solucion para: ',par1ant,dez0m
         write(*,*)'evaluando factor no ergodico'
         call facnoerg(dez0m,Sdek,g0,kmin,Nk,fnoer)
         do i=1,Nk
          write(9,*)fnoer(i,1),fnoer(i,2)
         enddo
         write(*,*)'calculando el maximo de S(k)'
         Smx=Smax(Sdek,Nk)
         write(10,*)par1ant,Smx
         goto 200
        endif
CC
...
CC
	if (dabs(solpost).lt.1.D-4)then
         write(8,*)par1post,integralpost,dez0m
         write(*,*)'se encontro solucion para: ',par1post,dez0m
         write(*,*)'evaluando factor no ergodico'
         call facnoerg(dez0m,Sdek,g0,kmin,Nk,fnoer)
         do i=1,Nk
          write(9,*)fnoer(i,1),fnoer(i,2)
...
CC
	if (dabs(solmed).lt.1.D-4)then
         write(8,*)par1med,integralmed,dez0m
         write(*,*)'se encontro solucion para: ',par1med,dez0m
         write(*,*)'evaluando factor no ergodico'
         call facnoerg(dez0m,Sdek,g0,kmin,Nk,fnoer)
         do i=1,Nk
          write(9,*)fnoer(i,1),fnoer(i,2)
