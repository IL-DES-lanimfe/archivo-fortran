...
!        OPEN (14,FILE='selfLJMfv7nu13.dat')	
!        OPEN (15,FILE='colLJMfv7nu13.dat')
!       OPEN (50,FILE='hdk.dat')
       OPEN (25,FILE='fktmaxnoSEXPLJMfv5146nu18.dat')
       OPEN (29,FILE='fktminnoSEXPLJMfv5146nu18.dat')
       OPEN (26,FILE='deltaznoSEXPLJMfv5146nu18.dat')
       OPEN (27,FILE='fktnoSEXPLJMfv5146nu18.dat')
       OPEN (28,FILE='sueltosnoSEXPLJMfv5146nu18.dat')
       OPEN (30,FILE='fsktnoSEXPLJMfv5146nu18.dat')
CC Mensaje inicial
       write(*,*)' '
        ...
        DO IT=NT2/2+1,MT,1  !COMIENZA INTERVALO TEMPORAL
         ...
         DO IA=1,NITER         !CICLO DE ITERACIONES        
          ...
          DO IK=1,NK         !CICLO SOBRE VECTORES DE ONDA
            CS(IK,IT)=DELTAZ(IT)*XLAM(IK) !CSSEXP(IK,IT)
