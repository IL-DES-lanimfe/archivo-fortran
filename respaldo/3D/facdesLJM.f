...
c
	open(50,file='fundisradLJMfv64nu13.dat')
	open(60,file='facdesLJMfv64nu13b.dat')
c... Reads inpud data
      call input(0.64D0,13.D0,0.255D0)
c... perform calculations
      call oz2(Sdek,Gder)
CC
	DO i=1,2**12
	 write(50,*)Gder(i,1),Gder(i,2)
	 write(60,*)Sdek(i,1),Sdek(i,2)
	enddo
	close(50)
	close(60)
c... end of program
...
c      
      x(1) = 1.0
      rmax = 5.0  ! rmax=800 para yukawas
