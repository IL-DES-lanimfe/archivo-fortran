...
C variables auxiliares
        Double precision pi,fv,siginv!,fve,Eul,lam
CC
CCCCCCCCCCCCCCCC Funciones que utiliza el programa CCCCCCCCCCCCCCCCCCC
CC
        double precision  lambda,kminima,diametro
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C                                                                   C
...
C archivo de salida funcional criterio 
        open(9,file='funcritreLJMnu4.dat')
	open(10,file='solucionesrenu40.dat')
CC
        pi= dacos(-1.D0)
CC
...
CC
	...
	write(*,*)' '
	write(*,*)'Es el caso de pot. de Lenard-Jones modificado'
	write(*,*)'parametro1:nu,parametro2:desidad de numero'
	write(*,*)' '
CC
...
CC
          fv=pi*(parametro2)/(6.D0*siginv**3)
c... Reads inpud data
      call input(fv,parametro1,0.68D0)
...
CC
	      ...
	      write(9,*)dzeta,integral,1.D0/dzeta
CC
...
c      
      x(1) = 1.0
      rmax = 60.0  ! rmax=800 para yukawas
